...
import { Box, Button, Center, FormControl, FormErrorMessage, FormLabel, Input, Textarea, useToast } from '@chakra-ui/react';
...
export default function Create(){
    ...
    return (
        <>
           <Center m={10} p={10} backgroundColor={'gray.200'}>

               <Box w="40%">
                   <Center> <h1>Créer un Hôtel</h1></Center>
                   <Formik
                       ...
                       onSubmit={async (values, actions) => {
                           ...
                           try{
                              const response = await axios.post('http://localhost:8000/api/hotels',values);
                              toast({
                                  title:`${response.data}`,
                                  status:"success",
                                  position:'top-right',
