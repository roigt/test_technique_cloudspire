                                ...
                                <Tr key={hotel.id} >
                                    ...
                                    <Td>
                                        <Box display="grid" gridTemplateColumns="repeat(2, 1fr)" gap="8px">
                                            <Button w="100px" colorScheme="blue" onClick={() => router.visit(`/hotels/new`)}>
                                                Créer
                                            </Button>

                                            <Button w="100px" colorScheme="orange" onClick={() => router.visit(`/hotels/${hotel.id}/update`)}>
                                                Modifier
                                            </Button>
